/* wickra-shazam C ABI — generated by cbindgen; do not edit by hand. */

#ifndef WICKRA_SHAZAM_H
#define WICKRA_SHAZAM_H
...
#define WICKRA_SHAZAM_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_SHAZAM_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_SHAZAM_ERR_PANIC -3
...
typedef struct WickraShazam WickraShazam;
...
int32_t wickra_shazam_command(WickraShazam *handle, const char *cmd_json, char *out, uintptr_t cap);
